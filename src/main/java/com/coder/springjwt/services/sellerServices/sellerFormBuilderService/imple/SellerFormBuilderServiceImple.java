...
public class SellerFormBuilderServiceImple  implements SellerFormBuilderService {
    ...
    public FormRootCapture getFormBuilder() {
        try {
            ...
            sizes.setId("06");
            sizes.setIdentifier("brandNames");
            sizes.setName("brandNames");
            sizes.setType("DROPDOWN-MUL");
            sizes.setRequired(true);
            sizes.setExclamationDesc("brandNames Name Examination");
            sizes.setMinLength("");
            sizes.setMaxLength("");
            sizes.setPattern("");
            sizes.setDescription("brandNames Price Desc");
            ...
            netQuantity.setName("netQuantity");
            ...
            countryOfOrigin.setName("countryOfOrigin");
            ...
            manufacturerName.setName("manufacturerName");
            ...
            manufacturerAddress.setName("manufacturerAddress");
            ...
            manufacturerPincode.setName("manufacturerPincode");
